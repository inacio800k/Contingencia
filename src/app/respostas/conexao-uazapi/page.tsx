...
export default function ConexaoUazapiPage() {
    const router = useRouter()
    const [data, setData] = useState<ConexaoUazapi[]>([])
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">Histórico de conexões Uazapi registradas</p>
                    </div>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-white/10 hover:bg-white/5">
                            ...
                            <TableHead className="text-blue-200">Conexão</TableHead>
                            <TableHead className="text-blue-200">Conta</TableHead>
