...
export default function ConexaoVendedoresPage() {
    const router = useRouter()
    const [data, setData] = useState<ConexaoVendedor[]>([])
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">Histórico de conexões registradas</p>
                    </div>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-white/10 hover:bg-white/5">
                            ...
                            <TableHead className="text-blue-200">Vendedor</TableHead>
                            <TableHead className="text-blue-200">Tipo Conexão</TableHead>
