...
export default function TrocaNumerosPage() {
    const router = useRouter()
    const [data, setData] = useState<TrocaNumero[]>([])
    ...
    }, [router]) // Initial load only, manual update via button
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">Histórico de trocas de números registrados</p>
                    </div>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-white/10 hover:bg-white/5">
                            ...
                            <TableHead className="text-blue-200">Número Antigo</TableHead>
                            <TableHead className="text-blue-200">Número Novo</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {loading ? (
