...
export default function ConexaoWahaPage() {
    const router = useRouter()
    const [data, setData] = useState<ConexaoWaha[]>([])
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">Histórico de conexões Waha registradas</p>
                    </div>
                </div>
