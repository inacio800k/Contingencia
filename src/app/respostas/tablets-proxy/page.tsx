...
export default function TabletsProxyPage() {
    ...
    const splitProxyCode = (code: string) => {
        if (!code) return { ip: '-', port: '-', user: '-', pass: '-' }
            ...
            <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400">Histórico de registros de proxy</p>
                    </div>
                </div>
                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-white/10 hover:bg-white/5">
                            ...
                            <TableHead className="text-blue-200">Instância</TableHead>
                            <TableHead className="text-blue-200">Ação</TableHead>
                            <TableHead className="text-blue-200">IP</TableHead>
                            <TableHead className="text-blue-200">Porta</TableHead>
                    ...
                    <TableBody>
                        {loading ? (
                            ...
                            data.map((row) => {
                                const proxyParts = splitProxyCode(row.codigo_proxy)
                                return (
